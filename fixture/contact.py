...
class ContactHelper:
    ...
    def create(self):
        ...
        firstname_field.send_keys("Kirs")
        ...
        lastname_field.send_keys("Vasiliev")
        ...
        homephone2_field.send_keys("444-444-555")
